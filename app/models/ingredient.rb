class Ingredient < ApplicationRecord
  ...
  validates :saturates, numericality: {greater_than_or_equal_to: 0}
  validates :carbohydrates, numericality: {greater_than_or_equal_to: 0}
  validates :sugar, numericality: {greater_than_or_equal_to: 0}
  validates :fibre, numericality: {greater_than_or_equal_to: 0}
